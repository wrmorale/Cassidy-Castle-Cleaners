...
public class Moth : Enemy
{
    ...
    ///*Seems to both attack and move at the same time*/
    //void FixedUpdate()
    //{
    //    enemyMovement();
    //}
    ...
    //    /*Maybe though if it doesn't have line of sight to the player, it should persue them?*/
    ...
    //            }
    //            else { /*What is called at the start when flee stops*/
